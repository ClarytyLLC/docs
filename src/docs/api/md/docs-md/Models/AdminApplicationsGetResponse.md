...
**limit** | [**Integer**](integer.md) | the number of applications to return. | [optional] [default to null]
**offset** | [**Integer**](integer.md) | the number of applications to skip before getting the result set | [optional] [default to null]
