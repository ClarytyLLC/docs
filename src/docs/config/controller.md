...
| *automate.node_red_engine_image* | string | registry.central.aiware.com/node-red-runner-v3:prod |  | The age of automate request for cleaning |
| *automate.node_red_studio_image* | string | registry.central.aiware.com/node-red-v3:prod |  | The age of automate request for cleaning |
