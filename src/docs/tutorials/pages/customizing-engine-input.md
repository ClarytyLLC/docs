...
These are just a few examples. There could be many other possible scenarios where you would use custom parameters.  You can easily pass an arbitary JSON data to an engine in aiWARE. Let us quickly go through how it is done.
